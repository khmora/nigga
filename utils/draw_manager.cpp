...
void render::setup( ) {
	...
	fonts[ ValiumTEXT ] = create_font( "Verdana", 12, FW_BOLD, FONTFLAG_DROPSHADOW );
	fonts[ ValiumBOLD ] = create_font( "Verdana", 12, FW_BOLD, FONTFLAG_OUTLINE );
	fonts[ ESPFLAG ] = create_font( "Verdana", 12, FW_THIN, FONTFLAG_OUTLINE );
	...
	fonts[ ESPNAME ] = create_font( "Verdana", 12, FW_BOLD, FONTFLAG_DROPSHADOW );
	...
	fonts[ INDICATORFONT ] = create_font( "Calibri", 24, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
	fonts[ TABFONT ] = create_font( "Verdana", 12, FW_NORMAL, FONTFLAG_ANTIALIAS );
	fonts[ ValiumFONT ] = create_font( "Verdana", 40, FW_NORMAL, FONTFLAG_ANTIALIAS );
}
