...
void setup_main_menu( ) {
	...
	auto rage_tab = new C_Tab( &menu::get( ), 1, "b", "rage", {
		...
		C_Tab::subtab_t( "pistol", 1, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "heavy", 2, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "rifle", 3, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "smg", 4, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "scout", 5, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "auto", 6, fonts[ SUBTABWEAPONS ] ),
		C_Tab::subtab_t( "shotgun", 7, fonts[ SUBTABWEAPONS ] )
	} ); {
		set_tabsub( 0 );
